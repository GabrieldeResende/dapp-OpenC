                ...
                <div className="container mx-auto pt-12 px-4 relative">
                    <div className="-mx-4 flex flex-wrap gap-6 items-end mb-12">
                        <div className="px-4 w-full lg:w-6/12 xl:w-5/12">
                            <h2 className="font-bold mb-4 text-2xl text-white">Gabriel Resende</h2>
                        </div>
                        <div className="px-4 w-full lg:w-auto ml-auto">
                            <div className="flex-wrap gap-2 inline-flex sm:gap-4">
                                <a href="#" className="bg-gradient-to-t bg-primary-500 from-primary-500 hover:bg-primary-600 hover:from-primary-600 hover:to-primary-500 inline-block p-3 rounded-full text-white to-primary-400" aria-label="instagram"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                                ...
                                <a href="#" className="bg-gradient-to-t bg-primary-500 from-primary-500 hover:bg-primary-600 hover:from-primary-600 hover:to-primary-500 inline-block p-3 rounded-full text-white to-primary-400" aria-label="linkedin"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                                ...
                                {/* Trocar para Github */}
                                <a href="#" className="bg-gradient-to-t bg-primary-500 from-primary-500 hover:bg-primary-600 hover:from-primary-600 hover:to-primary-500 inline-block p-3 rounded-full text-white to-primary-400" aria-label="github"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                    ...
                    <div className="py-4">
                        ...
                        <div className="flex flex-wrap -mx-4  items-center">
                            ...
                            <div className="px-4 py-2 w-full sm:w-auto">
                                <a href="#" className="hover:text-primary-600 text-primary-500">Privacy Policy</a> |
                                <a href="#" className="hover:text-primary-600 text-primary-500">Terms of Use</a>
                            </div>
                        </div>
                    </div>
                </div>
